        ...
        <div class="row">
            <div class="info">
                ...
                <table class='noselect'>
                    <form method='post'>
                    <tr><td class='main'>Valsts Nr. zīme</td><td class='value'><input type='text' name='autoVNZ' class='box' placeholder='Ievadi automašīnas Valsts nr. zīmi*' required/></td></tr>
                    <tr><td class='main'>Marka</td><td class='value'><input type='text' name='autoMarka' class='box' placeholder='Ievadi automašīnas marku*' required/></td></tr>
                    <tr><td class='main'>Modelis</td><td class='value'><input type='text' name='autoModelis' class='box' placeholder='Ievadi automašīnas modeli*' required/></td></tr>
                    <tr><td class='main'>Gads</td><td class='value'><input type='number' min='1950' max='2022' step='1' name='autoGads' class='box' placeholder='Ievadi automašīnas gadu*' required/></td></tr>
                    ...
                    <tr><td class='main'>Dzinēja tilpums</td><td class='value'><input type='number' min='1.2' max='3.0' step='0.1' name='autoDzinejaTilpums' class='box' placeholder='Ievadi automašīnas dzinēja tilpumu*' required/></td></tr>
                    ...
                    <tr><td class='main'>Attēls</td><td class='value'><input type='text' name='autoAttels' class='box' placeholder='Ievadi automašīnas attēla saiti*' required/></td></tr>
                    </from>
                </table>
